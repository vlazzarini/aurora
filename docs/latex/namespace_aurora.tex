...
S\+: sample type ~\newline
ph\+: phase  t\+: function table ~\newline
returns an interpolated sample \mbox{\Hypertarget{namespace_aurora_a3993d7b3f35ba929c5e59ba117252e1d}\label{namespace_aurora_a3993d7b3f35ba929c5e59ba117252e1d}} 
...
{\footnotesize\ttfamily template$<$typename S $>$ \\
S Aurora\+::reson (\begin{DoxyParamCaption}\item[{S}]{in,  }\item[{double $\ast$}]{c,  }\item[{double $\ast$}]{d }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$typename S $>$ \\
void Aurora\+::reson\+\_\+cfs (\begin{DoxyParamCaption}\item[{S}]{f,  }\item[{S}]{bw,  }\item[{S}]{fs,  }\item[{double $\ast$}]{c }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$typename S $>$ \\
void Aurora\+::reson\+\_\+cfs1 (\begin{DoxyParamCaption}\item[{S}]{f,  }\item[{S}]{bw,  }\item[{S}]{fs,  }\item[{double $\ast$}]{c }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$typename S $>$ \\
void Aurora\+::reson\+\_\+cfs2 (\begin{DoxyParamCaption}\item[{S}]{f,  }\item[{S}]{bw,  }\item[{S}]{fs,  }\item[{double $\ast$}]{c }\end{DoxyParamCaption})}
