...
\item 
const std\+::vector$<$ S $>$ \& \hyperlink{class_aurora_1_1_table_set_a886edb5453f4e4761f1d6aed7d998da2}{select} (S f) const
...
\mbox{\Hypertarget{class_aurora_1_1_table_set_a886edb5453f4e4761f1d6aed7d998da2}\label{class_aurora_1_1_table_set_a886edb5453f4e4761f1d6aed7d998da2}} 
\index{Aurora\+::\+Table\+Set@{Aurora\+::\+Table\+Set}!select@{select}}
\index{select@{select}!Aurora\+::\+Table\+Set@{Aurora\+::\+Table\+Set}}
\subsubsection{\texorpdfstring{select()}{select()}}
{\footnotesize\ttfamily template$<$typename S$>$ \\
const std\+::vector$<$S$>$\& \hyperlink{class_aurora_1_1_table_set}{Aurora\+::\+Table\+Set}$<$ S $>$\+::select (\begin{DoxyParamCaption}\item[{S}]{f }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
